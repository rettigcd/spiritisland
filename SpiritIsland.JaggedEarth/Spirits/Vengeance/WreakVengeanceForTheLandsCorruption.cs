...
/// </summary>
class WreakVengeanceForTheLandsCorruption( Space space ) 
	: TokenBinding( new TokenBinding( space, Token.Badlands ) ) 
{
	...
	readonly TokenBinding _blight = new TokenBinding( new TokenBinding( space, Token.Blight ) );
