...
namespace SpiritIsland.JaggedEarth {
	...
	[InnatePower("Slip the Flow of Time"), Fast, AnySpirit]
	[RepeatWithTime]
	class SlipTheFlowOfTime {
		...
		static public Task Option1( TargetSpiritCtx ctx ) {
			return new SpeedChanger( ctx.OtherCtx, Phase.Fast, 2 ).FindAndExecute();
		}
		...
		static public Task Option3( TargetSpiritCtx ctx ) {
			return ctx.Other.SelectAndPlayCardsFromHand();
		}
