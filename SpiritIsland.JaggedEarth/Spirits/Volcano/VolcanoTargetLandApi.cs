...
class VolcanoTargetLandApi : DefaultRangeCalculator {
	...
	public override IEnumerable<Space> GetTargetOptionsFromKnownSource( SelfCtx ctx, TargettingFrom powerType, IEnumerable<Space> source, TargetCriteria targetCriteria ) {
