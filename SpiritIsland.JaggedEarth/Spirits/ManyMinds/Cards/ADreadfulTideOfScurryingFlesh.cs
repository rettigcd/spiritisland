...
public class ADreadfulTideOfScurryingFlesh {
	...
	[SpiritCard(Name,0, Element.Moon, Element.Air,Element.Water, Element.Animal), Fast, FromSacredSite(1,Filter.TwoBeasts)]
	...
	static public async Task ActAsync(TargetSpaceCtx ctx ) {
		...
		while(0<removed--)
			ctx.Tokens.Skip1InvaderAction( Name, ctx.Self );
	}
