...
public class GiftOfTheSparkingSky {
	...
	public static Task PlusOneDamageToEach(TargetSpiritCtx ctx) {
	...
	public static Task GainMinor(TargetSpiritCtx ctx) {
	...
	public static Task PlayCardForCost(TargetSpiritCtx ctx) {
