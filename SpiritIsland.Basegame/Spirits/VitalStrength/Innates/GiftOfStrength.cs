...
public class GiftOfStrength {
	...
	[InnateTier("1 sun,2 earth,2 plant","Once this turn, Target Spirit may Repeat 1 Power Card with Energy cost of 1 or less.")]
	...
	[InnateTier("2 sun,3 earth,2 plant","Instead, the Energy cost limit is 3 or less.")]
	...
	[InnateTier("2 sun,4 earth,3 plant","Instead, the Energy cost limit is 6 or less.")]
