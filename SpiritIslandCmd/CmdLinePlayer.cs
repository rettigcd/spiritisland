	...
	public class CmdLinePlayer {
		...
		void ShowCards() {
			var cards = game.Spirit.Hand
				...
				.Cast<IActionFactory>()
				.Union( game.Spirit.GetUnresolvedActionFactories(Speed.Growth) )
				.Union( game.Spirit.GetUnresolvedActionFactories(Speed.Fast) )
				.Union( game.Spirit.GetUnresolvedActionFactories(Speed.Slow) )
				.Distinct()
