...
public class TormentingRotFlies {
	...
	[MinorCard( "Tormenting Rotflies", 1, Element.Air, Element.Plant, Element.Animal ),Slow,FromPresence( 2, Target.Sands, Target.Wetland )]
	...
	static public Task ActAsync( TargetSpaceCtx ctx ) {
		...
		return ctx.SelectActionOption(
			new SpaceCmd( "Add 1 disease", ctx => ctx.Disease.AddAsync(1) ),
