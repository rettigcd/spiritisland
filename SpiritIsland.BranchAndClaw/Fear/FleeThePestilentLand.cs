...
class FleeThePestilentLand : FearCardBase, IFearCard {
	...
	public Task Level2( GameState ctx ) // !! Flatten by selecting first space, then action is to remove it and optionally 2 more
		=> Cmd.Pick1(
	...
	public Task Level3( GameState ctx ) // !! Flatten by selecting first space, then action is to remove it and optionally 2 more
		=> Cmd.Pick1(
