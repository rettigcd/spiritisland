...
//public class IInvaderCard : IOption, IInvaderCard {

//	public static IInvaderCard Stage1( Terrain t1 ) => new IInvaderCard( new SingleTerrainFilter(t1), 1 );
//	public static IInvaderCard Stage2( Terrain t1 ) => new IInvaderCard( new SingleTerrainFilter(t1), 2 );
//	public static IInvaderCard Stage2Costal() => new IInvaderCard( new CostalFilter(), 2 );
//	public static IInvaderCard Stage3(Terrain t1,Terrain t2) => new IInvaderCard( new DoubleTerrainFilter( t1, t2 ), 3);
...
//	public IInvaderCard( SpaceFilter filter, int invaderStage ) {
//		_filter = filter;
//		InvaderStage = invaderStage;
//	}
//	protected IInvaderCard( IInvaderCard orig ) {
