...
public static class Is {
	...
	static public XFilter AdjacentToBlight => new XFilter( "land adjacent to blight", spaceCtx => spaceCtx.AdjacentCtxs.Any( adjCtx => adjCtx.Space.Blight.Any ) );
	...
	static bool MatchingSlotCard( TargetSpaceCtx ctx, InvaderSlot slot )
		=> slot.Cards.Any( card => card.Flipped && card.MatchesCard( ctx.Space ) );
