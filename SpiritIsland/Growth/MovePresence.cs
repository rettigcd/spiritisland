...
public class MovePresence : GrowthActionFactory, IActionFactory {
	...
	public override async Task ActivateAsync( SelfCtx ctx) {
		...
		var dst = await ctx.Decision( Select.Space.ForAdjacent("Move presence to:", src, Select.AdjacentDirection.Outgoing, dstOptions, Present.Always, ctx.Self.Presence.Token));
