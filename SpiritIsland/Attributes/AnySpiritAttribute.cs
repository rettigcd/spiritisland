...
namespace SpiritIsland {
	...
	public class AnySpiritAttribute : GeneratesContextAttribute {
		...
		public override async Task<object> GetTargetCtx( string powerName, SpiritGameStateCtx ctx, PowerType _ ) {
	...
	public class YourselfAttribute : AnySpiritAttribute {
		public override Task<object> GetTargetCtx( string powerName, SpiritGameStateCtx ctx , PowerType _ ) {
