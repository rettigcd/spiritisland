	...
	public class CropsWitherAndFade {
		...
		static public Task ActAsync( TargetSpaceCtx ctx ){
			...
			return ctx.SelectPowerOption(
				new PowerOption("replace town with explorer", () => Replace1(ctx,Invader.Town,Invader.Explorer)),
				new PowerOption("reaplce city with town", () => Replace1(ctx,Invader.City,Invader.Town))
			);
