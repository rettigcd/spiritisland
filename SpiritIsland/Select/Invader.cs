...
public static class Invader {
	...
	public static TokenFrom1Space ToRemove( SpiritIsland.Space space, IEnumerable<IVisibleToken> options ) 
	...
	public static TokenFrom1Space ForIndividualDamage(int damagePerInvader, SpiritIsland.Space space, IEnumerable<IVisibleToken> invaders)
		=> new TokenFrom1Space( $"Select invader to apply {damagePerInvader} damage", space, invaders.Distinct(), Present.Done );

	public static TokenFrom1Space ForAggregateDamage( SpiritIsland.Space space, IVisibleToken[] invaderTokens, int aggregateDamage, Present present) 
		=> new TokenFrom1Space($"Damage ({aggregateDamage} remaining)",space, invaderTokens, present );

	public static TokenFrom1Space ForAggregateDamageFromSource( SpiritIsland.Space space, HealthToken source, IVisibleToken[] invaderTokens, int aggregateDamage, Present present )
		=> new TokenFrom1Space( $"Damage from {source} ({aggregateDamage} remaining)", space, invaderTokens, present );

	public static TokenFrom1Space ForBadlandDamage(int remainingDamage, SpiritIsland.Space space, IEnumerable<IVisibleToken> invaders)
